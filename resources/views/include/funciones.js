...
/*
 msgError = "No se pudo cargar el listado de m&oacute;dulos";
 $("#msgError").attr('hidden', 'hidden');
 $("#msgWarning").attr('hidden','hidden');
 $("#msgSuccess").attr('hidden','hidden');
 $("#msgError").removeAttr('hidden');
 $("#msgErrorList").html(msgError);
